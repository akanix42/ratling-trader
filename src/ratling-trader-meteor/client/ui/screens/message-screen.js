"use strict";
MessageScreen.typeName = "messageScreen";
//InventoryScreen.$inject = ["display", "uiController", "asciiTileFactory", "inventoryScreen", "messageScreen"];
Ui.registerUnique(MessageScreen.typeName, MessageScreen);

function MessageScreen(display, ui, uiToGameBridge, asciiTileFactory) {
}
//
